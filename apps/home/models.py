...
class FichaOperativa(models.Model):
    ...
    fotoInicio = models.ImageField(blank=False, null=False)
    fotoDesarollo = models.ImageField(blank=False, null=False)
    fotoCulminado = models.ImageField(blank=False, null=False)
